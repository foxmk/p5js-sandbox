...
class Circle {
  ...
  intersects(other) {
    if (other instanceof Rectangle) {
      ...
      return this.x + this.r > other.x && other.x + other.w > this.x - this.r &&
          this.y + this.r > other.y && other.y + other.h > this.y - this.r;
...
class Rectangle {
  ...
  contains(point) {
    return !(point.position.x < this.x || point.position.x >= this.x + this.w ||
        point.position.y < this.y || point.position.y >= this.y + this.h);
  }

  intersects(other) {
    if (other instanceof Rectangle) {
      return this.x < other.x + other.w && other.x < this.x + this.w && this.y <
          other.y + other.h && other.y < this.y + this.h;
    } else if (other instanceof Circle) {
      // TODO: Fix collision detection
      let xx = other.x + other.r > this.x && this.x + this.w > other.x -
          other.r;
      let yy = other.y + other.r > this.y && this.y + this.h > other.y -
          other.r;
      return xx && yy;
    } else {
      throw TypeError('undefined type intersection');
...
class Quadtree {
  ...
  subdivide() {
    ...
    let br = new Rectangle(x + halfWidth, y + halfHeight, halfWidth,
        halfHeight);
